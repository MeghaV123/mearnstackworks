...
// transfer data(client to server-- servr to clnt)


country.forEach((data=>console.log(data.name.common )))//console.log(country[0].name["common"]);
country.forEach((pop=>console.log(pop.population)))
country.forEach((country=>console.log(country.currencies)))

// var symbol=country.map(country=>country[0].currencies["USD"].symbol)
// console.log(symbol);
// var symbol=country.map(country=>country[1].currencies["KYD"].symbol)
// console.log(symbol);
// var symbol=country.map(country=>country[2].currencies["EUR"].symbol)
// console.log(symbol);
// var symbol=country.map(country=>country[3].currencies["YER"].symbol)
// console.log(symbol);
// var symbol=country.map(country=>country[4].currencies["XOF"].symbol)
// console.log(symbol);